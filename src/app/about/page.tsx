      ...
      <section className="relative pt-24 pb-20 overflow-hidden text-center mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-slate-400 font-light leading-relaxed">
            FORENSIQ was founded on a simple realization: Most analytics tools tell you what happened, but leave you guessing as to why. We're here to bridge that gap with behavioral AI.
          </p>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                desc: "We built FORENSIQ to be the most privacy-respecting session tool on the market. Data is yours, PII is masked."
              },
              {
                icon: Rocket,
              ...
              >
                <div className="w-16 h-16 bg-slate-900 border border-slate-800 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl group-hover:border-emerald-500/40 transition-colors">
