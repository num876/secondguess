      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="text-left">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-7xl lg:text-[120px] xl:text-[150px] font-black text-white leading-tight lg:leading-[0.95] tracking-tighter mb-3 sm:mb-4 lg:mb-8"
          >
            Uncover the <br/>
